#!/usr/bin/env python3
"""
Symbiote CLI - Command line interface for the Symbiote coding assistant.
"""
import sys
import asyncio
...
async def main():
    ...
    if not google_key:
        print("⚠️  GOOGLE_API_KEY not found. Set it in .env file for Gemini code generation.")
    ...
    orchestrator = SymbioteOrchestrator()
